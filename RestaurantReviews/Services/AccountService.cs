...
namespace RestaurantReviews.Services
{
  public class AccountService
  {
    ...
    public AccountService(AccountsRepository repo, ReviewsRepository reviewsRepo)
    {
      _repo = repo;
    ...
    internal List<RestaurantReview> GetReviews(string id)
    {
      return _reviewsRepo.GetAllByAccountId(id);
    }
  }
}